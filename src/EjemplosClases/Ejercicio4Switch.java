...
public class Ejercicio4Switch
{
	public static void main(String[] args) throws IOException
	{
		...
		System.out.println("Ingrese un monto a pagar. Si paga al contado obtendr� un 10%");
		compra = Double.parseDouble(buffer.readLine());

		System.out.println("\n ELija un medio de pago, ingresando 1;2;3 � 4:\n1- Contado.\n2- Tarjeta de credito.\n3- Tarjeta de debito.\n4- Cheque. ");
		...
		case 4:
			...
			break;
		default:
				System.out.printf("\n- Ha ingresado una opci�n inv�lida. Ingrese 1;2;3 � 4.");
				break;
