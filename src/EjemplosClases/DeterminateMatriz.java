...
public static void main(String[] args) {
		...
		System.out.println("Arreglo m�ximo de 2 x 2 ");
		System.out.println("Arreglo de : ["+fila+"] X ["+columna+"]");
		System.out.println("Introduzca 1er n�mero: ");
		vector[0][0]=sc.nextInt();
		System.out.println("Introduzca 2do n�mero: ");
		vector[0][1]=sc.nextInt();
		System.out.println("Introduzca 3er n�mero: ");
		vector[1][0]=sc.nextInt();
		System.out.println("Introduzca 4to n�mero: ");
		...
		System.out.println("Ecuaci�n 1: ["+ecuacion1+"]");
		System.out.println("Ecuaci�n 2: ["+ecuacion2+"]");
	}
}
