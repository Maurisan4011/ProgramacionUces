...
public class PILA_MEMORIA_ESTATICA {
    ...
    //CREAMOS UN VECTOR SIN TAMA�O SE LO PEDIREMOS AL USUARIO
	int VECTOR_PILA[];
	int CIMA;
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println("introduzca tama�o de la PILA: ");
			medida = sc.nextInt();
			...
			do{
				...
				case 6:
					...
					System.out.println("El tama�o de la Pila es..."+apilar.SIZE_PILA_TAMNIO());
